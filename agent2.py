...
class Agent_2(Agent):
    def __init__(self, aid):
        super(Agent_2, self).__init__(aid=aid, debug=False)
        self.pos = [0,0]
        self.back = 0
        self.escaped = 0
    ...
    def on_start(self):
        super(Agent_2, self).on_start()
        display_message(self.aid.localname, "Recherche de la sortie...")
        self.call_later(15.0, self.escape)
    def sending_pos(self):
        ...
        message.set_sender(AID('agent_2'))
    ...
    def react(self, message):
        super(Agent_2, self).react(message)
        perPRO="propose"
        ontoPRO="deadend"
